        ...
        <!-- header -->
            ...
            @if(auth()->user()!= null)
                <div class="main-content">
                    @endif
                    <label for="start" style = " margin-top:20px; margin-bottom:20px; margin-left:350px; margin-right:50px; font: 2rem 'Fira Sans', sans-serif;">Elija una fecha para mostrar datos en el mapa:</label>
...
f
        ...
        /*
            ...
            async function inicializarMapa(prat, denia, aras, valencia, torrevieja) {
                ...
                var medicionIAQ1 = L.marker([38.966623, -0.175211], {icon: COIcon}, {time: "2013-01-22 07:42:26"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ2 = L.marker([38.992851, -0.195587], {icon: COIcon}, {time: "2013-01-22 07:42:26"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ3 = L.marker([38.991045, -0.165532],{icon: COIcon}, {time: "2013-01-22 08:42:26"}).bindPopup('La calidad del aire en este punto es mala'),
                    medicionIAQ4 = L.marker([38.994319, -0.161632], {icon: COIcon},{time: "2013-01-22 08:42:26"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ5 = L.marker([38.956838, -0.178382], {icon: COIcon},{time: "2013-01-22 09:00:26"}).bindPopup('La calidad del aire en este punto es mala'),
                    medicionIAQ6 = L.marker([38.986419, -0.165682], {icon: COIcon},{time: "2013-01-22 10:00:26"}).bindPopup('La calidad del aire en este punto es mala'),
                    medicionIAQ7 = L.marker([38.983519, -0.185682], {icon: COIcon},{time: "2013-01-22 11:00:26"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ8 = L.marker([38.996813, -0.175682], {icon: COIcon},{time: "2013-01-22 11:06:26"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ9 = L.marker([38.956719, -0.175562], {icon: COIcon},{time: "2013-01-22 11:10:26"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ10 = L.marker([38.976829, -0.175212],{icon: COIcon}, {time: "2013-01-22 11:20:26"}).bindPopup('La calidad del aire en este punto es mala'),
                    medicionIAQ11 = L.marker([38.986859, -0.168862], {icon: COIcon},{time: "2013-01-22 11:30:29"}).bindPopup('La calidad del aire en este punto es mala'),
                    medicionIAQ12 = L.marker([38.992229, -0.175342], {icon: COIcon},{time: "2013-01-22 12:03:29"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ13 = L.marker([38.984544, -0.165634],{icon: COIcon}, {time: "2013-01-22 12:23:29"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ14 = L.marker([38.976349, -0.182682],{icon: COIcon}, {time: "2013-01-22 12:29:29"}).bindPopup('La calidad del aire en este punto es mala'),
                    medicionIAQ15 = L.marker([38.968223, -0.177682], {icon: COIcon},{time: "2013-01-22 12:37:29"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ16 = L.marker([38.998224, -0.177683],{icon: COIcon}, {time: "2013-01-22 12:55:29"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ17 = L.marker([38.988243, -0.177682],{icon: COIcon}, {time: "2013-01-23 13:03:29"}).bindPopup('La calidad del aire en este punto es mala'),
                    medicionIAQ18 = L.marker([38.789987, -0.189682],{icon: COIcon}, {time: "2013-01-23 13:30:29"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ19 = L.marker([38.954423, -0.177682], {icon: COIcon},{time: "2013-01-23 14:03:29"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ20 = L.marker([38.969280, -0.187316], {icon: COIcon},{time: "2013-01-23 15:03:29"}).bindPopup('La calidad del aire en este punto es mala'),
                    medicionIAQ21 = L.marker([38.994423, -0.165434],{icon: COIcon}, {time: "2013-01-23 16:03:29"}).bindPopup('La calidad del aire en este punto es media'),
                    medicionIAQ22 = L.marker([38.893223, -0.167682], {icon: COIcon},{time: "2013-01-23 16:03:29"}).bindPopup('La calidad del aire en este punto es media'),
                    medicionIAQ23 = L.marker([38.988623, -0.178942], {icon: COIcon},{time: "2013-01-23 16:30:29"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ24 = L.marker([38.996723, -0.156632],{icon: COIcon}, {time: "2013-01-23 18:03:29"}).bindPopup('La calidad del aire en este punto es media'),
                    medicionIAQ25 = L.marker([38.993423, -0.176341],{icon: COIcon}, {time: "2013-01-23 19:03:29"}).bindPopup('La calidad del aire en este punto es buena'),
                    medicionIAQ26 = L.marker([38.979880, -0.189316],{icon: COIcon}, {time: "2013-01-23 20:03:29"}).bindPopup('La calidad del aire en este punto es mala'),
                    ...
                    medicionco8 = L.marker([38.946128, -0.177882], {time: "2022-01-14 18:30:29"}).bindPopup('El valor de CO en esta zona parece ser medio'),
                    medicionco9 = L.marker([38.924763, -0.176542],  {time: "2022-01-14 19:30:29"}).bindPopup('El valor de CO en esta zona parece ser medio'),
                    medicionco10 = L.marker([38.992318, -0.163282],  {time: "2022-01-14 20:30:29"}).bindPopup('El valor de CO en esta zona parece ser alto'),
                    medicionco11 = L.marker([38.976118, -0.163342], {time: "2022-01-14 21:30:29"}).bindPopup('El valor de CO en esta zona parece ser alto'),
                    medicionco12 = L.marker([38.869818, -0.189642],  {time: "2022-01-14 22:30:29"}).bindPopup('El valor de CO en esta zona parece ser bajo ');
