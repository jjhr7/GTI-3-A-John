        ...
        <!-- end message area-->
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{url('town/create')}}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-5">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control is-valid" id="altitude" name="altitude" placeholder="Town Altitude" required>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="postal_code">{{ __('Postal Code')}}<span class="text-red">*</span></label>
                                        <input type="number" class="form-control is-valid" id="postal_code" name="postal_code" placeholder="Postal code" required>
                                    </div>
                                </div>
